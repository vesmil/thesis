...
While VFS with encryption is less common, there also exists a non-virtual alternative as \xxx{TODO} \ldots % https://learn.microsoft.com/en-gb/windows/win32/fileio/file-encryption?redirectedfrom=MSDN
