...
So, order to judge the potential benefits of the proposed VFS, it is essential to examine alternative solutions to having those custom features and compare their capabilities, limitations, and applicability.
...
\subsection{Rationale and Alternatives}\label{subsec:fuse-analysis}
...
Although FUSE serves as the foundation for the VFS implementation, several other libraries will be employed to address various aspects of the project.
...
\xxx{Boost program options mainly for support tools}