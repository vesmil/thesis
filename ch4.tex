...
\xxx{What is best way to encrypt a file with user provided password?
...
\x{I have decided to not do diff but just store the whole file in the versioning system.
