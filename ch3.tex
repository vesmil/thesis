...
\xxx{Some intro about the diagram}

\begin{tikzpicture}
    \umlclass[x=0, y=0]{FuseWrapper}{
        -- std::string fuse\_library
    }{
        + virtual write() \\
        + virtual read() \\
        + virtual open() \\
    ...
    \umlclass[x=12, y=0]{VfsDecorator}{
        -- CustomVfs\& wrapped\_vfs
    }

    \umlclass[x=10, y=-4]{EncryptionVfs}{
    }{
        + write() \\
        + read()
    }

    \umlclass[x=14, y=-4]{VersioningVfs}{
    }{
        + write() \\
        + read()
    }
