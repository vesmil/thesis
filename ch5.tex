...
The encryption and decryption of files is trivially done on opening and closing the file, respectively.
However the situation is more complicated when it comes to directories.
The main problem is deciding when to encrypt and decrypt the files in the directory.
I have decided to solve it \xxx{TODO}.

Another complication lies in the combination of encryption and versioning.
\ldots
