...
To implement the prototype module of encryption, I have chosen to use the XChaCha20-Poly1305 described in the initial chapter~\ref{subsec:xchacha20-poly1305}.
I particularly used this algorithm implemented by the libsodium library as discussed in~\ref{subsec:encryption-analysis}.
